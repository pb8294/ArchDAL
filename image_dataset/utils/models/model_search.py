...
from utils.models.operations import *
from torch.autograd import Variable
from utils.models.genotypes import PRIMITIVES
from utils.models.genotypes import Genotype
...
class Network(nn.Module):
    ...
    def __init__(self, C, input_channel, num_classes, layers, criterion, steps=4, multiplier=4, stem_multiplier=3, switches_normal=[], switches_reduce=[], p=0.0):
...
#            cell = Cell(steps, multiplier, C_prev_prev, C_prev, C_curr, reduction, reduction_prev, switches)
    ...
    def forward(self, input, last=False, freeze=False):
        if freeze:
            with torch.no_grad():
